...
class Order(models.Model):
    ...
    user_profile = models.ForeignKey(Users, on_delete=models.SET_NULL,
    ...
    country = CountryField(blank_label='Please select country *',
                           null=False, blank=False)
    ...
    checkout_total = models.DecimalField(max_digits=10, decimal_places=2,
                                         null=False, default=0)
    original_basket = models.TextField(null=False, blank=False,
                                       default='')
