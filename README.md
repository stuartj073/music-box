...
I had also intended on a lot more content (blogs/reviews/products) being present on the site butI ultimately just ran out of time in the end. I plan to add more data to the project in the few days after the submission. I originally planned on allowing any user to the site to be able to upload their own product but after careful consideration I have chosen against it. Instead, I will upload many more products over the coming weeks as to show what kind of products I intend on advertising on the site.